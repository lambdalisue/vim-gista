...
let s:converter = {
      \ 'name': 'converter_gista_without_gistid',
      \ 'description': 'vim-gista gist converter which show informations without gistid',
      \}
...
function! unite#filters#converter_gista_without_gistid#define() " {{{
  return s:converter
endfunction " }}}
