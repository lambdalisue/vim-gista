...
let s:converter = {
      \ 'name': 'converter_gista_without_date',
      \ 'description': 'vim-gista gist converter which show informations without update date',
      \}
...
function! unite#filters#converter_gista_without_date#define() " {{{
  return s:converter
endfunction " }}}
